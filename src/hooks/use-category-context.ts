...
export const useAdminCategoryList = () => {
    ...
    if (!context) {
        throw new Error('useAdminCategoryList must be used within AdminCategoryListProvider');
    }
    return context;
};
...
export const useAdminDeletedCategoryList = () => {
    ...
    if (!context) {
        throw new Error('useAdminDeletedCategoryList must be used within AdminDeletedCategoryListProvider');
    }
    return context;
};
